...
$APP_CATALOG = [
    ...
    [
        ...
        'short_description' => 'The basic browser built-in to Gingerbread',
        'long_description' => '<p>Original Google-provided browser that was built-in to Android Gingerbread. Does not work with modern SSL or root certs, but may be useful for testing purposes.</p>',
        'features' => '<ul><li>Very old rendering engine</li><li>No modern SSL, TLS or Ciphers</li><li>Quite ugly</li></ul>',
        'version' => '2.6.3',
        'price' => '0.00',
        'rating' => 4,
        'publisher' => 'Google',
        'size' => '921.4 KB',
        'icon_url' => $BASE_URL . '/images/browser-icon.png',
        'download_url' => $BASE_URL . '/apps/browser-2.6.3.apk',
        'screenshots' => [],
        'category_id' => 'communication',
        'subcategory_id' => 'browsers',
        'tags' => ['bestseller'],
